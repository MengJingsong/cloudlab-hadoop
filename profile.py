...
SETUP = "https://archive.apache.org/dist/hadoop/core/hadoop-3.2.2/hadoop-3.2.2.tar.gz"
...
tour.Description( geni.rspec.igext.Tour.TEXT, "A cluster will run Hadoop 3.2.2. It includes a name node, a resource manager, and as many slaves as you choose." )
